...
agent = AgentDP(b_size, H, M, R, C, D, sigma, T, 2e-3, 3e-3)
...
def train_DP(Agent, criteria, max_steps, stop_critic, stop_policy, example = False):
    ...
    while (error > criteria) & (step < max_steps):
        ...
        while error_critic > stop_critic:
            ...
            x = x.double()
            error_critic1 = Agent.policy_evaluate(t, x)
            error_critic = error_critic1 - error_critic0
            error_critic0 = error_critic1
